...
class TestSet:
    @pytest.mark.unit
    def test_first_write_returns_true(self, state_cache: StateCache) -> None:
        """First write for a new attribute returns True (changed)."""
        assert state_cache.set("device_1", "isOn", True) is True

    @pytest.mark.unit
    def test_same_value_returns_false(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_different_value_returns_true(self, state_cache: StateCache) -> None:
        """Writing a different value returns True (changed)."""
        state_cache.set("device_1", "isOn", True)
        assert state_cache.set("device_1", "isOn", False) is True

    @pytest.mark.unit
    def test_none_is_valid_value(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_none_same_as_none_returns_false(self, state_cache: StateCache) -> None:
        """Writing None when None is cached returns False."""
        state_cache.set("device_1", "colorHue", None)
        assert state_cache.set("device_1", "colorHue", None) is False

    @pytest.mark.unit
    def test_zero_is_valid_value(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_zero_same_as_zero_returns_false(self, state_cache: StateCache) -> None:
        """Writing 0 when 0 is cached returns False."""
        state_cache.set("device_1", "lightLevel", 0)
        assert state_cache.set("device_1", "lightLevel", 0) is False

    @pytest.mark.unit
    def test_different_devices_independent(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_empty_logical_id_raises(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_empty_attribute_raises(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_whitespace_logical_id_raises(self, state_cache: StateCache) -> None:
...
class TestSetDeviceState:
    @pytest.mark.unit
    def test_bulk_write_all_new(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_bulk_write_partial_change(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_bulk_write_stores_values(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_bulk_write_empty_dict(self, state_cache: StateCache) -> None:
        """set_device_state with empty dict returns empty result."""
        result = state_cache.set_device_state("device_1", {})
        assert result == {}

    @pytest.mark.unit
    def test_bulk_write_invalid_attributes_type_raises(self, state_cache: StateCache) -> None:
        """set_device_state raises if attributes is not a dict."""
        with pytest.raises(DirigeraBridgeError) as exc_info:
            state_cache.set_device_state("device_1", invalid_state)
        assert exc_info.value.code == ErrorCode.INTERNAL_INVALID_ARGUMENT
...
class TestGet:
    @pytest.mark.unit
    def test_get_cached_value(self, state_cache: StateCache) -> None:
        """get() returns the cached value."""
        state_cache.set("device_1", "isOn", True)
        assert state_cache.get("device_1", "isOn") is True

    @pytest.mark.unit
    def test_get_returns_none_for_missing_attribute(self, state_cache: StateCache) -> None:
        """get() returns None for an uncached attribute."""
        state_cache.set("device_1", "isOn", True)
        assert state_cache.get("device_1", "lightLevel") is None

    @pytest.mark.unit
    def test_get_returns_default_for_missing_attribute(self, state_cache: StateCache) -> None:
        """get() returns the provided default for uncached attributes."""
        assert state_cache.get("device_1", "lightLevel", 50) == 50

    @pytest.mark.unit
    def test_get_returns_none_for_unknown_device(self, state_cache: StateCache) -> None:
        """get() returns None for an unknown device."""
        assert state_cache.get("unknown_device", "isOn") is None

    @pytest.mark.unit
    def test_get_returns_default_for_unknown_device(self, state_cache: StateCache) -> None:
        """get() returns the provided default for unknown devices."""
        assert state_cache.get("unknown", "isOn", "fallback") == "fallback"

    @pytest.mark.unit
    def test_get_empty_logical_id_raises(self, state_cache: StateCache) -> None:
...
class TestGetDeviceState:
    @pytest.mark.unit
    def test_returns_all_attributes(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_returns_empty_dict_for_unknown_device(self, state_cache: StateCache) -> None:
        """get_device_state returns {} for an unknown device."""
        assert state_cache.get_device_state("unknown") == {}

    @pytest.mark.unit
    def test_returns_copy(self, state_cache: StateCache) -> None:
...
class TestHasChanged:
    @pytest.mark.unit
    def test_not_cached_returns_true(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_does_not_write_to_cache(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_none_matches_cached_none(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_zero_matches_cached_zero(self, state_cache: StateCache) -> None:
...
class TestGetAllLogicalIds:
    @pytest.mark.unit
    def test_empty_cache_returns_empty_set(self, state_cache: StateCache) -> None:
        """Empty cache returns empty set."""
        assert state_cache.get_all_logical_ids() == set()

    @pytest.mark.unit
    def test_returns_all_device_ids(self, state_cache: StateCache) -> None:
...
class TestCounts:
    @pytest.mark.unit
    def test_device_count_empty(self, state_cache: StateCache) -> None:
        """device_count is 0 for empty cache."""
        assert state_cache.device_count() == 0

    @pytest.mark.unit
    def test_device_count(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_attribute_count_total(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_attribute_count_per_device(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_attribute_count_unknown_device(self, state_cache: StateCache) -> None:
...
class TestClearDevice:
    @pytest.mark.unit
    def test_clear_device_removes_all_attributes(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_clear_device_does_not_affect_others(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_clear_device_unknown_is_noop(self, state_cache: StateCache) -> None:
...
class TestClear:
    @pytest.mark.unit
    def test_clear_wipes_all_devices(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_clear_empty_cache_is_noop(self, state_cache: StateCache) -> None:
        """clear() on empty cache does not raise."""
        state_cache.clear()
        assert state_cache.device_count() == 0

    @pytest.mark.unit
    def test_can_write_after_clear(self, state_cache: StateCache) -> None:
...
class TestSnapshot:
    @pytest.mark.unit
    def test_snapshot_returns_all_data(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_snapshot_is_deep_copy(self, state_cache: StateCache) -> None:
    ...
    @pytest.mark.unit
    def test_snapshot_empty_cache(self, state_cache: StateCache) -> None:
        """snapshot() of empty cache returns empty dict."""
        assert state_cache.snapshot() == {}

    @pytest.mark.unit
    def test_snapshot_does_not_share_references(self, state_cache: StateCache) -> None:
